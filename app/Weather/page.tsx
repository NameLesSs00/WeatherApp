  ...
  return (
    <div className="text-center my-5 space-y-4">
      ...
      <div className="text-sm text-muted-foreground font-medium flex flex-col items-center gap-1">
        ...
        <span>
          Built with 🧑‍💻 <span className="font-semibold">Next.js</span> (frontend
          framework), 🎨 <span className="font-semibold">Shadcn UI</span> (UI
          components), 🌀 <span className="font-semibold">Framer Motion</span>{" "}
          (animation library), and 🌤️{" "}
          <span className="font-semibold">FreeCodeCamp API</span> (weather data)
        </span>
      </div>
